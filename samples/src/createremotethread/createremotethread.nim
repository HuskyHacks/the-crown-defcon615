#[
    From Nim on the Attack: Process Injection Using Nim and the Windows API (https://huskyhacks.dev/2021/07/17/nim-exploit-dev/)
    POC derrived from Marcello Salvati's OffensiveNim Repo (https://github.com/byt3bl33d3r/OffensiveNim/blob/master/src/shellcode_bin.nim)
